...
const Navbar = () => {
  ...
  return (
    <>
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-[#0f0a00]/80 backdrop-blur-md border-b border-[#d4a017]/50' : 'bg-transparent border-b border-transparent'}`}>
        <motion.div 
